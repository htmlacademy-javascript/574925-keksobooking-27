...
const OFFER_TITLES = ['Аренда квартиры', 'Аренда дворца', 'Аренда комнаты', 'Аренда дома', 'Аренда бунгало', 'Аренда коттеджа', 'Аренда палатки', 'Аренда гостиничного номера', 'Аренда картонной коробки', 'Аренда собачьей будки'];

const OFFER_DESCRIPTIONS = ['Красивая квартира для встреч на сутки', 'Норма хата загудеть на выходные', 'Дешманский номер в захудалой гостиннице', 'Брезентовая палатка для отдыха на природе', 'Переносная коробка для ночевок на улице', 'Домик с комарами в лесу', 'Крутой дворец мажориков', 'Будка вместе с собачьей охраной', 'Крыша из сена, но зато у моря', 'Специально для вас, наша конура по цене дворца',];
...
const TYPE_OF_BUILDINGS = ['palace', 'flat', 'house', 'bungalow', 'hotel'];
...
const createOfferData = () => ({
  ...
  type: getRandomValue(TYPE_OF_BUILDINGS),
  guests: getRandomInt(1, 3),
  checkin: getRandomValue(CHECKIN_TIMES),
  checkout: getRandomValue(CHECKOUT_TIMES),
